...
function analyze() {
    const lines = inputProductions.value.split('\n').map(l => l.trim()).filter(l => l)
    let isType0 = true; let isType1 = true; let isType2 = true; let isType3 = true
    let isRightLinear = true; let isLeftLinear = true
